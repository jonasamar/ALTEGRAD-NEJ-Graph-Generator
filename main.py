...
if args.prompt_encoder is not None:
    if args.prompt_encoder == 'distilbert-base-uncased':
        ...
        raise NotImplementedError(f"Prompt encoder '{args.prompt_encoder}' is not recognized.")
else:
    tokenizer = None
    bert_model = None
...
if args.train_denoiser:
    ...
    for epoch in range(1, args.epochs_denoise+1):
        ...
        for data in train_loader:
            ...
            if args.use_stats and (prompt_encoder_dim is not None):
